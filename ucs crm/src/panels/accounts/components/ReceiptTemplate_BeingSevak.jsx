...
export default function ReceiptTemplate_BeingSevak({ data, receiptNo }) {
  const d = data || {}
  return (
    <div data-receipt style={{ width: 1000, padding: 0, fontFamily: 'Arial, sans-serif', background: '#fff' }}>
      <div style={{ border: '3px solid #2e7d32', margin: 0, position: 'relative', overflow: 'hidden' }}>
        <div style={{ padding: '20px 30px 15px', textAlign: 'center', borderBottom: '2px solid #2e7d32', position: 'relative' }}>
          <img src="/receipt-assets/beingsevaklogo.jpeg" alt="Logo" style={{ position: 'absolute', left: 30, top: 15, height: 65, width: 'auto' }} />
          <h1 style={{ margin: 0, fontSize: 26, color: '#2e7d32', fontFamily: 'Georgia, serif' }}>Being Sevak Foundation</h1>
          <img src="/receipt-assets/beingsevakname.jpg" alt="Tagline" style={{ height: 28, marginTop: 4 }} />
          <p style={{ margin: '2px 0', fontSize: 13, color: '#444' }}>B-91, Street No. 9, Indira Vihar, Delhi-110009</p>
          <p style={{ margin: '2px 0', fontSize: 12, color: '#666' }}>Email: beingsevakfoundation@gmail.com | Mo: +91-8130810222</p>
          <p style={{ margin: '2px 0', fontSize: 11, color: '#888' }}>80G & 12A Registered | PAN: AAHCB0070Q</p>
          <img src="/receipt-assets/stamp.png" alt="Stamp" style={{ position: 'absolute', right: 40, top: 10, height: 65, width: 'auto', opacity: 0.75 }} />
        </div>

        <h2 style={{ textAlign: 'center', margin: '12px 0', fontSize: 20, color: '#2e7d32', textTransform: 'uppercase', letterSpacing: 3 }}>Receipt</h2>
