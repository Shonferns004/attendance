...
import { inspectImport, uploadImport, listImportBatches, getImportBatch, exportBatch, downloadSample, downloadTestSheet, uploadOldDataImport, distributeToNgos } from '../controllers/dataImportController.js';
...
router.post('/distribute-to-ngos', authenticateRole('super_admin'), distributeToNgos);
