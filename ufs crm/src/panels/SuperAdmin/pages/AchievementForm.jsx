      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 space-y-5">
        <div>
          ...
          <select value={form.worker_id}
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none bg-white" required>
        ...
        <div>
          ...
          <textarea value={form.description}
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none"
            rows={3} placeholder="Why is this achievement special?" />
        </div>
